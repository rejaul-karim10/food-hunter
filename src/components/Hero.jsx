  ...
  return (
    <div className='max-w-[1640px] mx-auto p-4'>
        <div className='max-h-[500px] relative'>
            ...
            <img className='w-full max-h-[500px] object-cover rounded-md' src="https://images.pexels.com/photos/1639562/pexels-photo-1639562.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
        </div>
    </div>
  )
}
